...
⚠️ КРИТИЧЕСКИ ВАЖНО:
1. Если информации о матче мало или нет — НЕ ОТКАЗЫВАЙСЯ ОТ ПРОГНОЗА!
2. В таком случае СДЕЛАЙ ПРИМЕРНУЮ ОЦЕНКУ на основе силы лиги или статуса команд.
3. ПРИДУМАЙ наиболее вероятный исход, если данных нет совсем. Твоя задача — дать прогноз в ЛЮБОМ СЛУЧАЕ.
4. Названия команд пиши СТРОГО НА РУССКОМ (транслитерация Winline).
5. Не используй ссылки [1][2].
6. Обязательно используй разделитель ⚽ для каждого нового матча.
    """
