...
class OddsFetcher:
    ...
    def get_odds(self, sport_key, regions='eu', markets='h2h'):
        ...
        Quota management: 500 req / month ~= 16 requests per day.
        We should only fetch if cache is empty or expired.
        """
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                print(f"  [Odds] API Success. Quota remaining: {remaining}")
                
                # Re-read formatted cache to return standardized dict
